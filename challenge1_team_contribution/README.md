...
**Idea**<br>
For each index `i`, calculate the product of all elements except `contributions[i]`.<br><br>
...
Store the result in `impact[i]`<br><br>

**Time Complexity**<br>
O(n²)<br><br>

**Space Complexity**<br>
O(1) (excluding output array)<br><br>

**Drawback**<br>
Inefficient for large arrays due to nested loops<br><br>

**2. Optimized Approach (Prefix and Suffix Products)**<br><br>
...
Multiply both to get the final result<br><br>
...
Update `rightProduct` by multiplying with `contributions[i]`<br><br>

**Example**<br>
For:<br>
`contributions = [1, 2, 3, 4]`<br>
Left products → `[1, 1, 2, 6]`<br>
Right products applied → `[24, 12, 8, 6]`<br><br>

**Time Complexity**<br>
O(n)<br><br>

**Space Complexity**<br>
O(1) extra space (output array excluded)<br><br>
